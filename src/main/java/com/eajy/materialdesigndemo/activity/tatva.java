...
public class tatva extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tatva);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top16);
        Glide.with(this).load(R.drawable.tatva).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
