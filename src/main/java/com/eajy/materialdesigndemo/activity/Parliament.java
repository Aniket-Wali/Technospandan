...
public class Parliament extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_topc5);
        Glide.with(this).load(R.drawable.parliament).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
