...
public class Fumes extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fumes);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top5);
        Glide.with(this).load(R.drawable.fumes).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
