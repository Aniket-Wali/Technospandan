...
public class Electrade extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_electrade);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top13);
        Glide.with(this).load(R.drawable.electrade).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
