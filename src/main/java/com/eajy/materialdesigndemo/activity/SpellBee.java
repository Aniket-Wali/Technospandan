...
public class SpellBee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_topc15);
        Glide.with(this).load(R.drawable.spellbee).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
