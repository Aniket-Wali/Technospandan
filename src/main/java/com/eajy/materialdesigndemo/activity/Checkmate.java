...
public class Checkmate extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_checkmate);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_tops1);
        Glide.with(this).load(R.drawable.chess).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
