...
public class TreasureHunt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_topc14);
        Glide.with(this).load(R.drawable.treasure_hunt).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
