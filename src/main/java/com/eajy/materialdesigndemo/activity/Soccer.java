...
public class Soccer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_tops3);
        Glide.with(this).load(R.drawable.soccer).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
