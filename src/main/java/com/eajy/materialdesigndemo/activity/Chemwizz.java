...
public class Chemwizz extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chemwizz);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top6);
        Glide.with(this).load(R.drawable.chemwizz).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
