...
public class ShowBuzz extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_show_buzz);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_topc11);
        Glide.with(this).load(R.drawable.showbuzz).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
