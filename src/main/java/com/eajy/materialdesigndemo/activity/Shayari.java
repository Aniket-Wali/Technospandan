...
public class Shayari extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_topc10);
        Glide.with(this).load(R.drawable.shayari).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
