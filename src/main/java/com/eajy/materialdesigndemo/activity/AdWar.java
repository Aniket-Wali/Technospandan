...
public class AdWar extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ad_war);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_topc1);
        Glide.with(this).load(R.drawable.ad_war).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
