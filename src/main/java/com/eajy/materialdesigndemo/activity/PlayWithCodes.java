...
public class PlayWithCodes extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_play_with_codes);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top11);
        Glide.with(this).load(R.drawable.play_with_codes).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
