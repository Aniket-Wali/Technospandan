...
public class Basketball extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_tops6);
        Glide.with(this).load(R.drawable.basketball).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
