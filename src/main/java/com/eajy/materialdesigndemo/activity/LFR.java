...
public class LFR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top10);
        Glide.with(this).load(R.drawable.lfr).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
