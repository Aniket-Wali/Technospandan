...
public class Roborace extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top4);
        Glide.with(this).load(R.drawable.robo_race).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
