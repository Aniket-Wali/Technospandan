...
public class Quizomania extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quizomania);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top17);
        Glide.with(this).load(R.drawable.quizomania).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
