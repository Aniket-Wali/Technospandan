...
public class Archery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_tops8);
        Glide.with(this).load(R.drawable.archery).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
