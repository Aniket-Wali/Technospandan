...
public class Nirmaan extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nirmaan);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top2);
        Glide.with(this).load(R.drawable.nirman).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
