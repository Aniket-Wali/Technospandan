...
public class Fashionnova extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fashionnova);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_topc9);
        Glide.with(this).load(R.drawable.fashionnova).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
