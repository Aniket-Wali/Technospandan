...
public class StartUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top18);
        Glide.with(this).load(R.drawable.startup).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
