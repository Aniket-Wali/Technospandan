...
public class OpenMic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_open_mic);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_topc2);
        Glide.with(this).load(R.drawable.open_mic).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
