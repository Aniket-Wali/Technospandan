...
public class Codetrex extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_codetrex);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top7);
        Glide.with(this).load(R.drawable.codetrex).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
