...
public class StockKing extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_stock_king);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_topc13);
        Glide.with(this).load(R.drawable.stock_king).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
