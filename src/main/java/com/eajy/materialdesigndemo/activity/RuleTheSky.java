...
public class RuleTheSky extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rule_the_sky);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top9);
        Glide.with(this).load(R.drawable.rule_the_sky).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
