...
public class AppAthon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top8);
        Glide.with(this).load(R.drawable.app_athon).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
