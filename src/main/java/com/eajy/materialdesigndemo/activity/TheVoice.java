...
public class TheVoice extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_the_voice);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_topc3);
        Glide.with(this).load(R.drawable.the_voice).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
