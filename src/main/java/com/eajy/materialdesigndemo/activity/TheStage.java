...
public class TheStage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_topc8);
        Glide.with(this).load(R.drawable.the_stage).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
