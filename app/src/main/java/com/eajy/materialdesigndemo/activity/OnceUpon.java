...
public class OnceUpon extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_once_upon);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_topc6);
        Glide.with(this).load(R.drawable.once_upon_a_time).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
