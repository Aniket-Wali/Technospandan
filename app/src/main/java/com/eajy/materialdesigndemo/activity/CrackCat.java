...
public class CrackCat extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_crack_cat);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top20);
        Glide.with(this).load(R.drawable.crack_cat).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
