...
public class Pixel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_topc12);
        Glide.with(this).load(R.drawable.pixel).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
