...
public class DanceFever extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dance_fever);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_topc4);
        Glide.with(this).load(R.drawable.dance_fever).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
