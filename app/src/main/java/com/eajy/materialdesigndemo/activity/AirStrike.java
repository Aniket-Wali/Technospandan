...
public class AirStrike extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_air_strike);
        ...
        Glide.with(this).load(R.drawable.air_strike).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
