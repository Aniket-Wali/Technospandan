...
public class NukkadNatak extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_topc7);
        Glide.with(this).load(R.drawable.nukkad_natak).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
