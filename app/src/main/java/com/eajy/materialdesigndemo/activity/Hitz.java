...
public class Hitz extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hitz);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top19);
        Glide.with(this).load(R.drawable.hitz).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
