...
public class marathon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_tops2);
        Glide.with(this).load(R.drawable.marathon).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
