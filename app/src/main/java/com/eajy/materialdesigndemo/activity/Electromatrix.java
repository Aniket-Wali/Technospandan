...
public class Electromatrix extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_electromatrix);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top14);
        Glide.with(this).load(R.drawable.electromatrix).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
