...
public class Crypto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top12);
        Glide.with(this).load(R.drawable.crypto).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
