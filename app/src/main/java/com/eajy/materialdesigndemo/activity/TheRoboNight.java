...
public class TheRoboNight extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_the_robo_night);
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top3);
        Glide.with(this).load(R.drawable.robo_night).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
