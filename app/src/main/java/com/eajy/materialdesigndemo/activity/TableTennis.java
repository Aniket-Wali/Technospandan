...
public class TableTennis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_tops4);
        Glide.with(this).load(R.drawable.tennis).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
