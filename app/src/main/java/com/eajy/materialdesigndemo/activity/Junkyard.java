...
public class Junkyard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_top15);
        Glide.with(this).load(R.drawable.junkyard).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
