...
public class LanGaming extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_tops7);
        Glide.with(this).load(R.drawable.lan_gaming).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
