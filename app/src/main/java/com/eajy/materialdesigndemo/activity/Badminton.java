...
public class Badminton extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_scrolling_top = findViewById(R.id.image_scrolling_tops5);
        Glide.with(this).load(R.drawable.badminton).apply(new RequestOptions().fitCenter()).into(image_scrolling_top);
    }
